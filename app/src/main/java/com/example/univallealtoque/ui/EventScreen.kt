...
fun EventScreen(
    ...
    if (isLoading) {
        ...
        val description = eventList.event_description ?: stringResource(R.string.default_event_description)
        ...
        val photo = eventList.photo ?: stringResource(R.string.default_photo_url)

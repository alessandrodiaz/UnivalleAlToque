...
fun CreateNewActivityScreen(
    ...
    var hasFocus1 by remember { mutableStateOf(false) }
        ...
        item {
            ...
            BasicTextField(
                ...
                modifier = Modifier
                    ...
                    .border(
                        width = 2.dp,
                        color = if (hasFocus) Color.Red else Color.Black,
            ...
            DemoSearchableDropdown(myHint = "10", myArrayOptions = numberVacancies, optionalFieldHorario=null, myComponentWithDP = 300)
